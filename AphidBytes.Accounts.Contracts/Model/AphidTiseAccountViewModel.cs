...
{
    public class AphidTiseAccountViewModel : IPaymentProvider, ISecurityQuestions, IAddressProvider, IAccountInfo
    {
        public AphidTiseAccountViewModel()
        {
        ...
        public Guid AphidTiseUserID { get; set; }
